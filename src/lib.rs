...
#![deny(
    ...
    // clippy::mod_module_files,mod.rs file is used clippy::modulo_arithmetic,
    ...
    clippy::rc_buffer,
    clippy::rc_mutex,
    clippy::rest_pat_in_fully_bound_structs,clippy::same_name_method,clippy::self_named_module_files,
    ...
    // clippy::use_debug,debug is allow for debug log clippy::verbose_file_reads,
